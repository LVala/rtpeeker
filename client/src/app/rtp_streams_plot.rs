...
fn build_stream_points(
    ...
    rtcp_packets.iter().for_each(|rtcp_info| {
        let on_hover = match &rtcp_info.packet {
            ...
            RtcpPacket::ApplicationDefined(_) => String::from("Goodbye"),
            RtcpPacket::PayloadSpecificFeedback(_) => String::from("Payload specific feedback"),
            RtcpPacket::TransportSpecificFeedback(_) => String::from("Transport specific feedback"),
            RtcpPacket::ExtendedReport(_) => String::from("Extended report"),
            RtcpPacket::Other(_) => String::from("Other rtcp"),
        };
